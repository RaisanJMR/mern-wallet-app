# Wallet Application
![image](./wallet-client//src/assets/gitAsset.png "Logo Title Text 1")
...
**API Integration:** Third-party api's like **cloudinary** service is also used to manage user media's
...
- create `.env` in the `wallet-client` root and addthe following
